...
compare_MDB <- function(former, new) {
  ...
  toRet <- dplyr::bind_rows(
    ...
    dplyr::tibble(
      ...
      "Identical" = (ccoll == ncoll && (ccoll == 0 || identical(ccm, ncm)))
    )
  )
